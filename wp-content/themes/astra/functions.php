...
function custom_empty_cart_message() {
    $html  = '<div class="col-12 offset-md-1 col-md-10"><p class="cart-empty woocommerce-info">';
    $html .= wp_kses_post( apply_filters( 'wc_empty_cart_message', __( 'No hay donaciones en proceso.', 'woocommerce' ) ) );
    echo $html . '</p></div>';
}
...
function quadlayers_custom_add_to_cart_message() {
   $message = 'Agrega un nombre y apellido, los demás campos son opcionales' ;
   return $message;
}
...
function wpse_124400_woomessages($translation, $text, $domain) {
    if ($domain == 'woocommerce') {
        if ($text == 'Cart updated.') {
            $translation = 'Donación actualizada.';
        }
    }
